    ...
    <div id="main-wrapper">
        ...
        <div class="nav-header">
            <a href="#" class="brand-logo">
                {{-- <h3 class="brand-title">OQ Clinic Dentist</h3> --}}
                {{-- <h2 class="logo-compact">OQ Clinic Dentist</h2> --}}
                 <img class="logo-abbr" src="{{asset('images/logooqadmin.png')}}" alt="">
                 <img class="logo-compact" src="{{asset('images/logotextdboq.png')}}" alt=""> 
                <img class="brand-title" src="{{asset('images/oqrekammedis.png')}}" alt="">  
            </a>
